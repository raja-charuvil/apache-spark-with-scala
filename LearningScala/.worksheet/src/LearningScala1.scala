...
object LearningScala1 {;import org.scalaide.worksheet.runtime.library.WorksheetSupport._; def main(args: Array[String])=$execute{;$skip(154); 
  // VALUES are immutable constants. You can't change them once defined.
  val hello: String = "Namaskaram!";System.out.println("""hello  : String = """ + $show(hello ));$skip(17); 
  ...
  // Solution
  val piValue = Pi;System.out.println("""piValue  : Double = """ + $show(piValue ));$skip(19); 
  println(piValue);$skip(55); 

object LearningScala3 {;import org.scalaide.worksheet.runtime.library.WorksheetSupport._; def main(args: Array[String])=$execute{;$skip(225); 
  ...
  // Solution
	def toUpper(str: String): String = {
		str.toUpperCase
	};System.out.println("""toUpper: (str: String)String""");$skip(27); 
	
	println(toUpper("cat"));$skip(78); 
	
	def transformStr(str: String, f: String => String): String = {
		f(str)
	};System.out.println("""transformStr: (str: String, f: String => String)String""");$skip(43); val res$3 = 
	
	transformStr("cat", x => x.toUpperCase);System.out.println("""res3: String = """ + $show(res$3))}
}

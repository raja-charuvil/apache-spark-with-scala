...
object LearningScala1 {
  ...
  val hello: String = "Namaskaram!"               //> hello  : String = Namaskaram!
  println(hello)                                  //> Namaskaram!
  
  // Notice how Scala defines things backwards from other languages - you declare the
  // name, then the type.
  
  // VARIABLES are mutable
  var helloThere: String = hello                  //> helloThere  : String = Namaskaram!
  helloThere = hello + " There!"
  println(helloThere)                             //> Namaskaram! There!
  ...
  val immutableHelloThere = hello + "There!"      //> immutableHelloThere  : String = Namaskaram!There!
  println(immutableHelloThere)                    //> Namaskaram!There!
  ...
  // Solution
  val piValue = Pi                                //> piValue  : Double = 3.141592653589793
  println(piValue)                                //> 3.141592653589793
  println(f"Double value of pi is ${piValue * 2}%.3f")
                                                  //> Double value of pi is 6.283
